...
{% details For Computer Science Students %}

### Week 1-2: Foundation Building

1. **Start with**: 3Blue1Brown Neural Networks series (visual intuition)
2. **Follow up**: Coursera Computational Neuroscience (mathematical foundation)
3. **Practice**: Basic perceptron implementation in PyTorch

### Week 3-4: Biological Context

1. **Read**: Selected chapters from Theoretical Neuroscience
2. **Watch**: Artem Kirsanov's neuroscience animations
3. **Experiment**: Brian2 simple neuron models

### Month 2: Choose Your Focus

- **Theory Track**: Deep dive into Neuronal Dynamics textbook
- **Applied Track**: Neuromatch Academy coursework
- **Research Track**: Begin reading recent NeuroAI papers

{% enddetails %}

{% details For Neuroscience Students %}

### Foundation in Computation

1. **Start with**: Machine Learning Specialization on Coursera
2. **Programming**: Python basics + NumPy/SciPy
3. **Mathematical prep**: Linear algebra and calculus review

### Bridge to NeuroAI

1. **Key resource**: Neuroscience for Machine Learners course
2. **Hands-on**: PyTorch tutorials focusing on neural networks
3. **Integration**: Read Brain-Inspired AI papers for perspective
...
- **Summer Programs**: [Lumiere Research](https://www.lumiere-education.com/post/15-journals-to-publish-your-research-in-high-school)
- **AI Programs**: [Inspirit AI](https://www.inspiritai.com/blogs/ai-blog/top-summer-research-programs-for-high-school-students)
- **Independent Research**: Start with literature reviews on specific NeuroAI topics

### Undergraduate Students

- **REU Programs**: Focus on computational neuroscience REUs
- **Lab Rotations**: Contact labs from the institutions list above
- **Online Collaboration**: Contribute to open-source neuroscience tools

### Graduate Students & Postdocs

- **Fellowship Opportunities**: NSF, NIH, and private foundation fellowships
- **Conference Networking**: Attend COSYNE, NeurIPS for community building
- **Collaborative Projects**: Cross-disciplinary projects between CS and neuroscience departments
